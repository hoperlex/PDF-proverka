...
**Переиздание строк от 2026-09-02 (волна 0.0.03).** Пин `ci.yml` переиздан четырежды.
...
| `.github/workflows/ci.yml` | `9d5528a0a76c94fcde77601d5c9f857d78b08676d94beed3f9f70a2338f255a1` |

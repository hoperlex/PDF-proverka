...
**Переиздание строк от 2026-09-02 (волна 0.0.03).** Пин `ci.yml` переиздан пять раз.
...
Пятый — регресс-гейт и полосы unit/contract/integration переведены в
...
| `.github/workflows/ci.yml` | `42397297c33dda67ab2fd263a867c2418185bbdf5698507d64e29be61132e2c8` |

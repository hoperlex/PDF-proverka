...
**Переиздание строк от 2026-09-02 (волна 0.0.03).** Пин `ci.yml` переиздан трижды.
...
| `.github/workflows/ci.yml` | `21ee8320db83ff70ac3ca103a5b3af68f3aa312502fd9961aa4c5d4fc17bdcb1` |

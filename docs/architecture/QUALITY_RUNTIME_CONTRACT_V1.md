...
**Переиздание строк от 2026-09-02 (волна 0.0.03).** Пин `ci.yml` переиздан шесть раз.
...
Шестой — исправление пятого: блокировка по ПОЛОСЕ снята обратно, оставлена
...
| `.github/workflows/ci.yml` | `d86967d5d16a16535a1a6de530585390d598ea47a6a37d4a56c5a1a58a137126` |

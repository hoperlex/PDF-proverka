...
| № | Решение | Исправление |
| --- | --- | --- |
| N1 | Принято; выбран ступенчатый budget | Полный capability freeze перенесён с W0 на G1. До G1 разрешён один активный product slot на волну и не более 20% human integration capacity; после G1 — ноль новых legacy endpoints/capabilities |
...
W0 ───────────── W1 ───────────── G1 ───────────── W2+
  ...
  ≤20% human       ≤20% human       contract-hardening still allowed
```

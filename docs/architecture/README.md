...
8. [Шаблон ADR](ADR_TEMPLATE.md) — форма нового архитектурного решения.
9. [Реестр исключений](EXCEPTIONS.md) — временные нарушения принципов с owner и
   expiry.
10. [Разбор ревью 2026-08-27](REVIEW_DISPOSITION_2026-08-27.md) — принятые,
   оспоренные и оставленные развилкой замечания.
11. [Разбор ревью R2](REVIEW_DISPOSITION_2026-08-27_R2.md) — исправления дефектов,
   внесённых первым ужесточением.
12. [Разбор ревью R3](REVIEW_DISPOSITION_2026-08-27_R3.md) — пересчёт W0,

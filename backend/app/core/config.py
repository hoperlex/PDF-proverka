...
#
# Классификация: это НЕ feature flag, а постоянный kill-switch, поэтому даты
# удаления у него нет. Само по себе это НЕ делает §8 DoD п.10 выполненным:
# отсутствие даты — отклонение, и оно оформлено как EXC-0002 в
# docs/architecture/EXCEPTIONS.md с компенсирующими контролями. Основание:
